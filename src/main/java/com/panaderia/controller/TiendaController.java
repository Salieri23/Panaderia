...
public class TiendaController {
     ...
     */
   // Dentro de TiendaApiController.java o como lo hayas llamado
...
public ResponseEntity<?> procesarPedido(@RequestBody Map<String, Object> datosPedido) {
    ...
    try {
        ...
        // 4. Crear el registro de pago (¡LA PARTE CORREGIDA!)
        // Usamos un ID fijo, igual que en el sistema de administradores.
        // Asumimos que el ID 1 corresponde a "Completado". ¡VERIFÍCALO EN TU BD!
